...
export const Stream = new ServiceType("Stream", [
    { name: "StreamState", serverStreaming: true, clientStreaming: true, options: {}, I: User, O: StateMessage },
    { name: "AVStream", serverStreaming: true, clientStreaming: true, options: {}, I: AVFrameData, O: AVFrameData }
]);
